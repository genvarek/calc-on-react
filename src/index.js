...
class Calculator extends React.Component {
  ...
  render () {
    ...
    const { displayValue, clearText, operation, } = this.state
    return (
        <div className="calculator">
            ...
            <div className="keypad">
                ...
                <Key className={`key-operation ${operation === '/' ? 'key-active' : '' }`} onClick={() => this.doOperation('/')}>&divide;</Key> <br/>
                ...
                <Key className={`key-operation ${operation === '*' ? 'key-active' : '' }`} onClick={() => this.doOperation('*')}>&times;</Key>  <br/>
                ...
                <Key className={`key-operation ${operation === '-' ? 'key-active' : '' }`} onClick={() => this.doOperation('-')}>-</Key> <br/>
